          ...
          <div class="col-md-5 d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18 color-1 align-items-stretch">
              <div class="text">
                ...
                <strong class="number" data-number="211201">0</strong>
                <span>Children in India</span>
              </div>
            </div>
          </div>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-5 heading-section ftco-animate text-center">
            ...
            <p>Illiteracy in India is a problem which has complex dimensions attached to it. Illiteracy in India is more or less concerned with different forms of disparities that exist in the country. There are gender imbalances, income imbalances, state imbalances, caste imbalances, technological barriers which shape the literacy rates that exist in the country. India possesses the largest illiterate population.</p>
          </div>
        </div>
        <div class="row">
              ...
              <div class="item">
                <div class="cause-entry">
                  ...
                  <div class="text p-3 p-md-4">
                    ...
                    <span class="fund-raised d-block">₹1,00,000 raised of ₹2,50,000</span>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="cause-entry">
                  ...
                  <div class="text p-3 p-md-4">
                    ...
                    <span class="fund-raised d-block">₹2,20,000 raised of ₹5,00,000</span>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="cause-entry">
                  ...
                  <div class="text p-3 p-md-4">
                    ...
                    <span class="fund-raised d-block">₹3,00,000 raised of ₹5,00,000</span>
                  </div>
                </div>
              </div>
